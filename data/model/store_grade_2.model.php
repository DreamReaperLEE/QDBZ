...
class store_grade_2Model extends Model {

    public function __construct(){
        parent::__construct('store_grade_2');
    }
    /**
     * 列表
     *
    ...
    private function _condition($condition){
        ...
        if ($condition['sg_id'] != ''){
            $condition_str .= " and store_grade_2.sg_id = '". $condition['sg_id'] ."'";
        }
    ...
    public function add($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::insert('store_grade_2',$tmp);
            return $result;
        }else {
            return false;
        }
    ...
    public function updates($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('store_grade_2',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = Db::delete('store_grade_2',$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function getGradeShopList($condition,$page=''){
        $condition_str = $this->_condition($condition);
        $param = array(
                    'table'=>'store_grade_2,store',
                    'field'=>'store_grade_2.*,store.*',
                    'where'=>$condition_str,
                    'join_type'=>'left join',
                    'join_on'=>array(
                        'store_grade_2.sg_id = store.grade_id',
                    )
                );
