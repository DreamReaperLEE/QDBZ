...
class buy_1Logic {
    ...
    public function calcCartList($store_cart_list) {
        ...
        foreach ($store_cart_list as $store_id => $store_cart) {
            ...
            $model_seller = Model('seller_group_spend');
    ...
    public function limitSpend($store_cart_list) {
        if (empty($store_cart_list) || !is_array($store_cart_list)) return array($store_cart_list,array(),0);
        ...
        foreach ($store_cart_list as $store_id => $store_cart) {
            ...
            foreach ($store_cart as $key => $cart_info) {
                ...
                if ( $goods_info['gc_id_2'] == '4') {
                    ...
                    $price = ($model_goods->getGoodsNewPrice($cart_info,1))/((strtotime($enddate)-strtotime($begindate))/86400);}
                    if($model_seller->getSellerGroupLim($condition2,1,$price)){
                ...
                return false;}}
                    ...
                    if($model_seller->getSellerGroupLim($condition2,$goods_info['gc_id_1'],$model_goods->getGoodsNewPrice($cart_info,1))){
