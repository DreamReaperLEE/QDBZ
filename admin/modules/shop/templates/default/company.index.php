...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['nc_company_manage'];?></h3>
        <h5><?php echo $lang['nc_company_manage_subhead'];?></h5>
      </div>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li><?php echo $lang['company_help1'];?></li>
    </ul>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=store&op=get_xml&is_company=1',
        colModel : [
            {display: '操作', name : 'operation', width : 150, sortable : false, align: 'center', className: 'handle'},
            {display: '保障单位ID', name : 'store_id', width : 40, sortable : true, align: 'center'},
            {display: '保障单位名称', name : 'store_name', width : 150, sortable : false, align: 'left'},
            {display: '保障单位管理员账号', name : 'member_id', width : 120, sortable : true, align: 'left'},
            {display: '商家账号', name : 'seller_name', width : 120, sortable : false, align: 'left'},
            {display: '保障单位头像', name : 'store_avatar', width: 60, sortable : false, align : 'center'},
            {display: '保障单位logo', name : 'store_label', width: 60, sortable : false, align : 'center'},
            {display: '保障单位等级', name : 'grade_id', width : 80, sortable : true, align: 'center'},
            {display: '保障单位入驻时间', name : 'store_time', width : 100, sortable : true, align: 'center'},
            ...
            {display: '保障单位分类', name : 'sc_id', width : 80, sortable : true, align: 'left'},
        ...
        searchitems : [
            {display: '保障单位名称', name : 'store_name', isdefault: true},
            {display: '保障单位管理员账号', name : 'member_name'},
...
function fg_operations(name, bDiv) {
    if (name == 'haoshop_add') {
        window.location.href = 'index.php?act=company&op=haoshop_add';
    }
}
