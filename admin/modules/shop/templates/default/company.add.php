...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=store&op=list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        ...
        <h3>保障单位 - <?php echo $lang['nc_new'];?></h3>
        <h5>保障单位相关设置与管理</h5>
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>新增的保障单位默认为开启状态，新增后，请手动编辑保障单位的其它初始信息</li>
      <li>新增保障单位默认没有绑定经营类目，请手动绑定其经营类目</li>
      <li>新增保障单位将自动创建保障单位管理员账号（用于登录网站会员中心）以及商家账号（用于登录商家中心）</li>
    </ul>
  </div>
  <form id="store_form" method="post">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="store_name"><em>*</em>保障单位名称</label>
        </dt>
        <dd class="opt">
...
$(function(){
    ...
    $('#store_form').validate({
        ...
        messages : {
            store_name: {
                required : '<i class="fa fa-exclamation-circle"></i>请输入保障单位名称',
                remote   : '<i class="fa fa-exclamation-circle"></i>保障单位名称已存在'
            },
            member_name: {
                ...
                remote   : '<i class="fa fa-exclamation-circle"></i>此名称已被其它保障单位会员占用，请重新输入'
            },
            seller_name: {
                ...
                remote  : '<i class="fa fa-exclamation-circle"></i>此名称已被其它保障单位占用，请重新输入'
            },
            member_passwd : {
