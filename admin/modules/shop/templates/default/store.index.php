...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=store&op=get_xml&is_company=0',
        colModel : [
            {display: '操作', name : 'operation', width : 150, sortable : false, align: 'center', className: 'handle'},
            {display: '供应商ID', name : 'store_id', width : 40, sortable : true, align: 'center'},
            {display: '供应商名称', name : 'store_name', width : 150, sortable : false, align: 'left'},
            {display: '供应商管理员账号', name : 'member_id', width : 120, sortable : true, align: 'left'},
            {display: '商家账号', name : 'seller_name', width : 120, sortable : false, align: 'left'},
            {display: '供应商头像', name : 'store_avatar', width: 60, sortable : false, align : 'center'},
            {display: '供应商logo', name : 'store_label', width: 60, sortable : false, align : 'center'},                        
            {display: '供应商等级', name : 'grade_id', width : 80, sortable : true, align: 'center'},
            {display: '供应商入驻时间', name : 'store_time', width : 100, sortable : true, align: 'center'},
            ...
            {display: '供应商分类', name : 'sc_id', width : 80, sortable : true, align: 'left'},
        ...
        searchitems : [
            {display: '供应商名称', name : 'store_name', isdefault: true},
            {display: '供应商管理员账号', name : 'member_name'},
