      ...
      <div class="tabs-panels">
        ...
        <div class="addr-note">
          ...
          <dl>
            ...
            <dd><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>&nbsp;&nbsp;,&nbsp;<?php echo @$output['order_info']['extend_order_common']['reciver_info']['area'];?></dd>
              <dt>项目名称<?php echo $lang['nc_colon'];?></dt>
              <dd><?php echo @$output['order_info']['extend_order_common']['reciver_info']['street'];?></dd>
          </dl>
          <dl>
