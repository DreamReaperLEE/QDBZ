...
<h3>  <?php
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      <tr>
        <th>附件名称：</th>
        <td colspan="20"><?php echo $output['joinin_detail']['enclosure_name'];?></td>
      </tr>
      <tr>
        <th>附件电子版：</th>
        <td colspan="20"><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['enclosure_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['enclosure_electronic']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
  ...
  if($output['joinin_detail']['is_company']=='1')
  {
    ...
    <tbody>
      <tr>
        ...
        <td>'.$output['joinin_detail']['taxpayer_id'].'</td>
      </tr>
    </tbody>
  </table>
        <table border="0" cellpadding="0" cellspacing="0" class="store-joinin" id = >
        <thead>
        <tr>
        ...
        <tr>
            ...
            <td>'.$output['joinin_detail']['invoice_title'].'</td>
        </tr>
        </tbody>
    </table>';
  }
  ...
  <form id="form_store_verify" action="index.php?act=store&op=store_joinin_verify" method="post">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      <thead>
        <tr>
          <th colspan="20"><?php echo $accountname?>经营信息</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <th class="w150"><?php echo $accountname?>账号：</th>
          <td><?php echo $output['joinin_detail']['seller_name'];?></td>
        </tr>
        <tr>
          <th class="w150"><?php echo $accountname?>名称：</th>
          <td><?php echo $output['joinin_detail']['store_name'];?></td>
        </tr>
        <tr>
          <th><?php echo $accountname?>等级：</th>
          <td><?php echo $output['joinin_detail']['sg_name'];?>（签约费用：<?php echo $output['joinin_detail']['sg_price'];?> 元/年）</td>
        </tr>
        <tr>
          <th class="w150">签约时长：</th>
          <td><?php echo $output['joinin_detail']['joinin_year'];?> 年</td>
        </tr>
        <tr>
          <th><?php echo $accountname?>分类：</th>
          <td><?php echo $output['joinin_detail']['sc_name'];?>（签约保证金：<?php echo $output['joinin_detail']['sc_bail'];?> 元）</td>
        </tr>
        <tr>
          <th>应付总金额：</th>
