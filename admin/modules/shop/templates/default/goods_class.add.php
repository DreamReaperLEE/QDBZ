  ...
  <form id="goods_class_form" enctype="multipart/form-data" method="post">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dl class="row">
            <dt class="tit">
                <label for="gc_sort">英文标题</label>
            </dt>
            <dd class="opt">
                <input type="text" name="gc_title" id="gc_title" class="txt" value="<?php echo $output['class_array']['gc_title'];?>" >
                <span class="err"></span>
                <p class="notic"></p>
            </dd>
        </dl>
        <dl class="row">
            ...
            <dd class="opt">
                <div class="input-file-show"><span class="show"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_GOODS_CLASS.DS.$output['class_array']['gc_image']);?>"> <i class="fa fa-picture-o" onMouseOver="toolTip('<img src=<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_GOODS_CLASS.DS.$output['class_array']['gc_image']);?>>')" onMouseOut="toolTip()"></i> </a></span><span class="type-file-box">
            ...
            <input type="text" name="gc_image" id="textfield1" class="type-file-text" />
        ...
        <dl class="row">
            <dt class="tit">
                <label for="gc_sort">分类描述</label>
            </dt>
            <dd class="opt">
                <textarea type="text" style="height: 100px;width: 280px;" name="gc_description" id="gc_description" class="txt"><?php echo $output['class_array']['gc_description'];?></textarea>
                <span class="err"></span>
                <p class="notic"></p>
            </dd>
        </dl>
