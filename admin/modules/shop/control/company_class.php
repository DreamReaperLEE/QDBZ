...
class company_classControl extends SystemControl{
    ...
    public function store_classOp(){
        ...
        $model_class = Model('store_class_2');
		...
		Tpl::setDirquna('shop');
        Tpl::showpage('company_class.index');
    }
    ...
    public function store_class_addOp(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    $url = array(
                    array(
                    'url'=>'index.php?act=company_class&op=store_class_add',
                    'msg'=>$lang['continue_add_store_class'],
                    ),
                    array(
                    'url'=>'index.php?act=company_class&op=store_class',
		...
		Tpl::setDirquna('shop');
        Tpl::showpage('company_class.add');
    }
    ...
    public function store_class_editOp(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    showMessage($lang['nc_common_save_succ'],'index.php?act=company_class&op=store_class');
                }else {
                    showMessage($lang['nc_common_save_fail']);
                }
            }
		...
		Tpl::setDirquna('shop');
        Tpl::showpage('company_class.edit');
    }
    ...
    public function store_class_delOp(){
        ...
        showMessage($lang['nc_common_del_fail'],'index.php?act=company_class&op=store_class');
    }
