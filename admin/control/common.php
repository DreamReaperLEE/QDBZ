...
// 				$save_file2 = BASE_UPLOAD_PATH.'/'.$_POST['filename'];
    ...
    private function get_pending_matters() {
        ...
        // 供应商申请数
        $statistics['store_joinin'] = Model('store_joinin')->getStoreJoininCount(array('joinin_state' => array('in', array(10, 11)),'is_company' => 2));
        // 保障单位申请数
        $statistics['store_joinin2'] = Model('store_joinin')->getStoreJoininCount(array('joinin_state' => array('in', array(10, 11)),'is_company' => 1));
        //店铺续签申请
