...
class company_centerControl extends BaseCompanyControl {
...
//         Tpl::output('help_list',$help_list);
        ...
        $_SESSION['menu2']=$this->_getMenuList2();
        //$_SESSION['menu']=$_SESSION['menu2'];
        //Tpl::output('menu2', $this->_getMenuList2());
