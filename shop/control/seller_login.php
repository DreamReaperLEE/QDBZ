        ...
        if ($seller_info['is_company'] == 1) {
                ...
                if ($member_info) {
                    ...
                    if ($seller_info['is_company']) {
                        $_SESSION['seller_group_name'] = '保障单位用户';
                        $is_company = 1;
                    ...
                    //$_SESSION['seller_menu3'] = $seller_menu['seller_menu'];
    ...
    public function login2Op()
    {
        ...
        if ($seller_info['is_company'] == 2) {
            ...
            if ($member_info) {
                ...
                //redirect('index.php?act=seller_center2');
            } else {
                showMessage('用户名密码错误', '', '', 'error');
            }
