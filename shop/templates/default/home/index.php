                    ...
                    <div class="weui-bgf weui-bod pro">
                        ...
                        <ul>
                            ...
                            <?php foreach($val['goods'] as $v) { ?>
                                <li class="clearfix"><a href="<?php echo urlShop('goods','index',array('goods_id'=> $v['goods_id']));?>" class="weui-fl el1"> <?php echo substr_text($v['goods_name'], 0,12);?></a><span class="weui-fr"><?php echo date('m-d',$v['goods_addtime'])?></span></li>
                            <?php } ?>
                            <?php } ?>
                        </ul>
                    </div>
            ...
            <div class="col-md-6 col-lg-6 col-sm-6">
                <div class="pro weui-bgf weui-bod">
                    ...
                    <ul>
                        <?php if(!empty($val['goods']) && is_array($val['goods'])) { ?>
                        <?php foreach($val['goods'] as $v) { ?>
                        <li class="clearfix"><a href="<?php echo urlShop('goods','index',array('goods_id'=> $v['goods_id']));?>" class="weui-fl el1"> <?php echo substr_text($v['goods_name'],0,36)?></a><span class="weui-fr"><?php echo date('m-d',$v['goods_addtime'])?></span></li>
                        <?php } ?>
                        <?php } ?>
                    </ul>
                </div>
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-4">
                                <div class="pro weui-bgf weui-bod lh24">
                                    ...
                                    <div class="weui-pl5 weui-pr5">
                                        <a class="weui-db weui-pt10 weui-f16 weui-pb5 el1"><?php echo substr_text($v['goods_name'],0,36)?></a>
