...
<div class="breadcrumb"><span class="icon-home"></span><span><a href="<?php echo SHOP_SITE_URL;?>">首页</a></span> <span class="arrow">></span> <span>保障单位入驻申请</span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3>保障单位入驻申请</h3>
    ...
    <div class="content">
      ...
      <dl show_id="0">
        ...
        <dd>
          <ul>
            <li class="<?php echo $output['step'] == '1' ? 'current' : '';?>"><i></i>保障单位资质信息</li>
            <li class="<?php echo $output['step'] == '2' ? 'current' : '';?>"><i></i>财务资质信息</li>
            <li class="<?php echo $output['step'] == '3' ? 'current' : '';?>"><i></i>保障单位经营信息</li>
          </ul>
        </dd>
      </dl>
      <dl>
  ...
  <div class="right-layout">
    <div class="joinin-step">
      <ul>
        ...
        <li class="<?php echo $output['step'] >= 1 ? 'current' : '';?>"><span>保障单位资质信息</span></li>
        <li class="<?php echo $output['step'] >= 2 ? 'current' : '';?>"><span>财务资质信息</span></li>
        <li class="<?php echo $output['step'] >= 3 ? 'current' : '';?>"><span>保障单位经营信息</span></li>
        <li class="<?php echo $output['step'] >= 4 ? 'current' : '';?>"><span>合同签订及缴费</span></li>
        <li class="step6"><span>保障单位开通</span></li>
      </ul>
    </div>
    <div class="joinin-concrete">
      <?php require('store_joinin2_apply.'.$output['sub_step'].'.php'); ?>
    </div>
  </div>
</div>
