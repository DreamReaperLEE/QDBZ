...
<div id="apply_store_info" class="apply-store-info">
  <div class="alert">
    <h4>注意事项：</h4>
    保障单位经营类目为商城商品分类，请根据实际运营情况添加一个或多个经营类目。</div>
  <form id="form_store_info" action="index.php?act=store_joinin2&op=step4" method="post" >
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      <thead>
        <tr>
          <th colspan="20">保障单位经营信息</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <th class="w150"><i>*</i>保障单位账号：</th>
          <td><input id="seller_name" name="seller_name" type="text" class="w200"/>
            <span></span>
            <p class="emphasis">此账号为日后登录并管理商家中心时使用，注册后不可修改，请牢记。</p></td>
        </tr>
        <tr>
          <th class="w150"><i>*</i>机构名称：</th>
          <td><input name="store_name" type="text" class="w200"/>
            <span></span>
            <p class="emphasis">机构名称注册后不可修改，请认真填写。</p></td>
        </tr>
        <tr>
            <th class="w150"><i>*</i>发票抬头：</th>
            <td><input name="invoice_title" type="text" class="w200"/>
        </tr>
        <tr>
          <th><i>*</i>保障单位等级：</th>
        ...
        <tr>
          ...
          <td><select name="sc_id" id="sc_id">
            ...
            <span></span>
            <p class="emphasis">请根据您所经营的内容认真选择保障单位分类，注册后商家不可自行修改。</p></td>
        </tr>
...
$(document).ready(function(){
    ...
    jQuery.validator.addMethod("seller_name_exist", function(value, element, params) { 
        ...
        $.ajax({  
            type:"GET",  
            url:'<?php echo urlShop('store_joinin2', 'check_seller_name_exist');?>',  
            async:false,  
    ...
    $('#form_store_info').validate({
        ...
        rules : {
            ...
            store_name: {
                required: true,
                maxlength: 50,
                remote : '<?php echo urlShop('store_joinin2', 'checkname');?>'
            },
            invoice_title: {
                required: true,
                maxlength: 22
