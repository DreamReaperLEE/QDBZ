        ...
        <dd>
          <ul>
		    <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_joinin&op=index" title="<?php echo $lang['hao_enter'];?>"><?php echo $lang['hao_enter'];?></a></li>
              <?php
              if(empty($_SESSION) ==true || $_SESSION['is_company'] != 0){
                  echo '<li><a href="'.urlShop('seller_login','show_login').'" target="_blank" title="'.$lang['hao_seller_login'].'">'.$lang['hao_seller_login'].'</a></li>';
              }
              ?>
          </ul>
	 </dd>
