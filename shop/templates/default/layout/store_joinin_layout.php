...
<body>
<div class="header">
    <h2 class="header_logo"><a href="<?php echo SHOP_SITE_URL; ?>"><img
                    src="<?php echo UPLOAD_SITE_URL . DS . ATTACH_COMMON . DS . $output['setting_config']['site_logo']; ?>"
                    class="pngFix"></a></h2>
    <ul class="header_menu">
        <li class="<?php echo $output['show_sign'] == 'joinin' ? 'current' : ''; ?>"><a
                    href="<?php echo urlShop('show_joinin', 'index'); ?>" class="joinin"><i></i>
                <?php
                parse_str($_SERVER['QUERY_STRING'], $get);
                if($get["act"] == "store_joinin")
                    echo "供应商入驻申请";
                else if($get["act"] == "store_joinin2")
                    echo "保障中心入驻申请";
                else
                    echo "商家入驻申请";
                ?></a></li>
        <li class=""><a href="<?php echo urlShop('seller_center', 'index'); ?>" class="login"><i></i>
                <?php
                if($get["act"] == "store_joinin")
                    echo "供应商管理中心";
                else if($get["act"] == "store_joinin2")
                    ...
                    echo "商家管理中心";
                ?></a></li>
        <li class="<?php echo $output['show_sign'] == 'help' ? 'current' : ''; ?>"><a
                    href="<?php echo urlShop('show_help', 'index'); ?>" class="faq"><i></i>
                <?php
                if($get["act"] == "store_joinin")
                    echo "供应商帮助指南";
                else if($get["act"] == "store_joinin2")
