  ...
  <div class="wrapper">
    ...
    <nav class="ncsc-nav">
      <dl class="<?php echo $output['current_menu']['model'] == 'index'?'current':'';?>">
        <dt><a href="index.php?act=company_center&op=index">首页</a></dt>
        <dd class="arrow"></dd>
      </dl>
      <?php if(!empty($_SESSION['menu2']) && is_array($_SESSION['menu2'])) {?>
      <?php foreach($_SESSION['menu2'] as $key => $menu_value) {?>
...
<div class="ncsc-layout wrapper">
  ...
  <div id="layoutRight" class="ncsc-layout-right">
    <div class="ncsc-path"><i class="icon-desktop"></i>保障单位管理中心<i class="icon-angle-right"></i><?php echo $output['current_menu']['model_name'];?><i class="icon-angle-right"></i><?php echo $output['current_menu']['name'];?></div>
