...
<div class="wrap">
    <div class="tabmenu">
        ...
        <?php if($output['isadmin']==1) {?><a href="javascript:void(0)" class="ncbtn ncbtn-bittersweet" nc_type="dialog" dialog_title="<?php echo 新增项目;?>" dialog_id="my_address_edit"  uri="index.php?act=member_address&op=address&type=add" dialog_width="550" title="<?php echo $lang['member_address_new_address'];?>"><i class="icon-map-marker"></i><?php echo 新增项目;?></a><?php } ?>
    ...
    <table class="ncm-default-table" >
        ...
        <?php foreach($output['address_list'] as $key=>$address){?>
          ...
          <p><?php echo $lang['member_address_edit_member'];?></p>
          </a>
