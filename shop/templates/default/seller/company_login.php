...
<div class="ncsc-login-container">
  <div class="ncsc-login-title">
    <h2>供应商</h2>
    <h4><a href="<?php echo urlShop('seller_login', 'show_login');?>">保障单位</a></h4>
    <span>请使用入驻申请时填写的“管理员用户名”作为登录用户名<br/>
    登录密码则商城用户密码一致</span></div>
  <form id="form_login" action="index.php?act=company_login&op=login" method="post" >
