  ...
  <div class="adds">
    ...
    <form method="post" action="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_address&op=address" id="address_form" target="_parent">
      ...
      <dl>
        ...
        <dt><i class="required">*</i><?php echo '负责人'.$lang['nc_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i><?php echo 项目地点.$lang['nc_colon'];?></dt>
        <dd><input type="hidden" name="region" id="region" value="<?php echo $output['address_info']['area_info'];?>">
        </dd>
      </dl>
      <dl>
        <dt><i class="required">*</i><?php echo 项目名称.$lang['nc_colon'];?></dt>
        <dd>
...
<!--      </dl>-->
      ...
      <div class="bottom">
        <label class="submit-border">
          <input type="submit" class="submit" value="<?php if($output['type'] == 'add'){?><?php echo 新增项目;?><?php }else{?><?php echo 编辑项目;?><?php }?>" />
        </label>
